// NOTE (FalconFPGA, 2026-07-13): three unpacked-array ranges converted from
// SystemVerilog single-value form to Verilog-2001 ([N] -> [0:N-1]) for Gowin
// plain-Verilog synthesis mode. No functional change. Upstream:
