...
REM Cygwin DLLs that the riscv32-elf-* tools need to run.
...
REM Heap ceiling 0x03000000: above _end, below the 68k ST-RAM window
REM at 0x04000000, below stack top 0x08000000.
